...
public class TaskController {
    ...
    public void save(Task task) {
        ...
        try {
            ...
            throw new RuntimeException("Erro ao salvar a tarefas " + ex.getMessage(), ex);
        } finally {
    ...
    public void update(Task task) {
        ...
        try {
            ...
            throw new RuntimeException("Erro ao atualizar as tarefas " + ex.getMessage(), ex);
        }
    }
